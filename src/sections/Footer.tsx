...
//       <h1 className="text-2xl font-bold">Jayaru Perera</h1>
//     </div>

//     <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
//     Dedicated tech enthusiast leveraging technology to solve real-world challenges
//     </p>
...
//       <li>
//         <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> Tournaments </a>
//       </li>
...
//       <li>
//         <a
//           href="https://web.facebook.com/profile.php?id=100091775292637"
//           rel="noreferrer"
//           target="_blank"
...
//       <li>
//         <a
//           href="https://www.instagram.com/jayaru_perera/"
//           rel="noreferrer"
//           target="_blank"
//           className="text-gray-700 transition hover:text-gray-700/75"
//         >
...
//       <li>
//         <a
//           href="https://github.com/JayaruPerera"
//           rel="noreferrer"
//           target="_blank"
//           className="text-gray-700 transition hover:text-gray-700/75"
//         >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="grid md:grid-cols-3 md:items-center">
            <div className="md:col-span-2">
              ...
              <span className=" inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">jayaruperera1998@gmail.com 
